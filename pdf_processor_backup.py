from PyPDF2 import PdfReader, PdfWri            # Open PDF with PyMuPDF for text extraction
...
class PDFProcessor:
    ...
    def extract_text_with_ocr(self, pdf_path, log_callback=None):
        ...
        try:
            ...
            # Also open with PyPDF2 for page objects
            with open(pdf_path, 'rb') as file:
                ...
                for page_num in range(len(doc)):
                    ...
                    # Get the corresponding PyPDF2 page object
                    # Note: We don't store the page object to avoid file handle issues
    ...
    def create_zip_output(self, grouped, output_folder, timestamp, progress_callback, log_callback):
        ...
        try:
            ...
            return {"success": True, "output_path": zip_path}
    ...
    def create_individual_pdfs(self, grouped, output_folder, timestamp, progress_callback, log_callback):
        ...
        try:
            ...
            return {"success": True, "output_path": batch_folder, "files": created_files}
